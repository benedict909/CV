...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links [here](https://benedict909.github.io/)")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/benedict909/CV/raw/master/Benedict_Monteiro_CV_2020-06-12.pdf)")
}
```
...
<!-- Academic References {data-icon=chalkboard-teacher} -->
<!-- -------------------------------------------------------------------------------- -->
